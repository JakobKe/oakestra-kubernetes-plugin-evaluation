...
func main() {
	...
	// Undeploy Tests
	undeployLoadTest(filePath)

	fmt.Println("Start Timestamp of Test:  ", START)

}

func deployLoadTest(filePath string) error {
...
func undeployLoadTest(filePath string) error {
