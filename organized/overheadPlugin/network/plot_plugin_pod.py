...
for framework in frameworks:
    ...
    create_and_save_plot(framework_bytes_data, f'Total Bytes by Pod and Type for {framework.capitalize()} Framework', 'Total Bytes', f'plugin_pod_total_bytes_{framework.lower()}.png')
    create_and_save_plot(framework_packets_data, f'Total Packets by Pod and Type for {framework.capitalize()} Framework', 'Total Packets', f'plugin_pod_total_packets_{framework.lower()}.png')
