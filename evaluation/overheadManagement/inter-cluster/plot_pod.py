...
sorted_bytes_data = bytes_data.groupby('framework_pod')['value'].sum().reset_index().nlargest(30, 'value')
...
sorted_packets_data = packets_data.groupby('framework_pod')['value'].sum().reset_index().nlargest(30, 'value')
