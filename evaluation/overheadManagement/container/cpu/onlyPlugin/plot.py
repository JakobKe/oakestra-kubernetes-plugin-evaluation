...
# Überprüfen, ob alle 'oakestra'-Einträge ersetzt wurden
if 'oakestra' in data['framework'].unique():
    raise ValueError("Es gibt immer noch 'oakestra'-Einträge in den Daten.")
