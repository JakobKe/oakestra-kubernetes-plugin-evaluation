...
sum_bytes_data['framework'] = sum_bytes_data['framework'].replace({'oakestra': 'K-oakestra'})
sum_packets_data['framework'] = sum_packets_data['framework'].replace({'oakestra': 'K-oakestra'})
...
plt.legend(title='Type', loc='upper left', fontsize=legend_font_size, title_fontsize=title_font_size)
